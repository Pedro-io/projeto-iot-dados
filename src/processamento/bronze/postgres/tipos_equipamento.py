...
class TiposEquipamentoETL(AbstractETL):
    """ETL para extração da tabela de domínio `tipos_equipamento` do PostgreSQL.

    Carga completa (full load) - tabela de referência pequena e raramente alterada.
    """
    ...
    def __init__(
        ...
        super().__init__(
            spark=spark,
            table_path="bronze/postgres/tipos_equipamento",
    ...
    def extract(self) -> None:
        """Extrai todos os registros de tipos de equipamento."""
        logger.info("Extraindo dados de erp_legado.tipos_equipamento")
        self.df = self._jdbc_read("erp_legado.tipos_equipamento")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="ETL Bronze - PostgreSQL Tipos de Equipamento")
    ...
    spark = (
        ...
        .appName("bronze-postgres-tipos-equipamento")
    ...
    logger.info("Iniciando pipeline Bronze - PostgreSQL Tipos de Equipamento")
